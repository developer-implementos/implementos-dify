const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Cuenta Implementos Dify',
    langGeniusAccountTip: 'Tu cuenta Implementos Dify y los datos de usuario asociados.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitación enviada, y pueden iniciar sesión en Implementos Dify para acceder a tus datos del equipo.',
  ...
  about: {
    ...
    nowAvailable: 'Implementos Dify {{version}} ya está disponible.',
    latestAvailable: 'Implementos Dify {{version}} es la última versión disponible.',
  },
  appMenus: {
    overview: 'Monitoreo',
    promptEng: 'Orquestar',
